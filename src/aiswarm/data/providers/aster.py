...
NOTE: This module defines the data structures and interface.
Actual MCP tool invocation happens via the execution layer or
direct MCP calls in the agent runtime. The methods here return
structured data from raw MCP tool responses.
"""
...
# --- Canonical data types for market data ---
...
class AsterDataProvider:
    ...
    Usage pattern:
        # In agent or coordinator code:
        raw = await mcp_call("mcp__aster__get_klines", symbol="BTCUSDT", interval="1h", limit=100)
